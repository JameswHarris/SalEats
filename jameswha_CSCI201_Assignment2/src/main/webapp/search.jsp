    ...
    <c:forEach items="${data}" var="element">  
	  	<div class="media" style = "border-bottom:1px solid silver">
					<div class="media-left">
						<a href="DetailsDispatcher?id=<c:out value="${element.getID()}"/>"> <img style="object-fit:cover; border-radius:25px; width: 200px; height: 200px; margin: 5px 60px 10px 100px;" src = "${element.getimage_url()}" /> </a> </br>
					</div>
					<div class="media-body" style="margin-top:10px">
						...
						<p> Review Count: ${element.getReviewCount()} </p>
						<p> Rating: ${element.getRating()} </p>
						<a href="${element.getUrl()}" style=" text-decoration:none; color: #7F7F7F"> Yelp Link <br> </a>
					</div>
				</div>
